...
![A filled bar labelled "net worth, a stock" next to yearly bars labelled "GDP, a flow."](images/stock-vs-flow.svg)
...
![A wide "GMV ₹1,000 Cr" bar, a small "revenue ₹50 Cr" bar, and a sliver of profit.](images/gmv-funnel.svg)
...
![A stacked income bar showing each slab taxed only on the income inside it; a raise is taxed only on the top slice.](images/marginal-tax.svg)
...
![A descending ladder: 10x shrinks to ~9.7% a year, ~3.5% after inflation, near zero after costs.](images/land-ladder.svg)
