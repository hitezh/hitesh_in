...
There is also a broader pattern worth noting. I [wrote recently](/2026/apple-ai-inference-silicon/) about how companies that build custom inference fleets have started renting them out: SpaceX built the Colossus cluster and [handed the whole thing to Anthropic](https://www.cnbc.com/2026/05/06/anthropic-spacex-data-center-capacity.html) for a reported $1.25 billion a month, and Meta says a cloud business is ["definitely on the table"](https://www.cnbc.com/2026/05/27/mark-zuckerberg-says-meta-starting-cloud-business-on-the-table.html). OpenAI is at the start of that same journey. Until now they have been renters, running on Nvidia GPUs and Azure capacity. Jalapeño is the first step toward owning the stack. Whether they eventually find themselves with more inference capacity than they can use, and face the same landlord question SpaceX did, is worth watching.
